...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="box-body">
            <form action ="<?php echo base_url('berita/update/'. $berita['idberita']);?>" method="POST">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control summernote" name="isi_berita" value="" id="isi_berita" placeholder="Isi Berita" required><?= $berita['isi_berita']; ?></textarea>
                </div>
                <div class="form-group">
